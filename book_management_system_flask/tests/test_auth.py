...
class TestAuthView:
    def test_register_success_admin_user(self, test_client, test_app):
        # 登録ページのGETリクエストが成功する
    ...
    def test_register_success_general_user(self, test_client, test_app):
        # ユーザー登録フォームのPOSTリクエストが is_admin を含まずに成功する
        response = test_client.post(
            "/auth/register",
            data={"username": "general_user", "password": "new_password"},
        )
